package as3bootstrap.flex.moxie.model
{
	...
	import as3bootstrap.flex.moxie.service.css.FlexMoxieStylesheetService;
	import as3bootstrap.flex.moxie.service.css.IFlexMoxieStylesheetService;
	
	import flash.events.Event;
	import flash.text.StyleSheet;
	
	/**
	 * Flex3 stylesheet model
	 * 
	 ...
	 * @author krisrange
	 */
	public class BootstrapFlexMoxieStylesheetModel 
		...
		implements IBootstrapStylesheetModel
	{
		 ...
		 * @inheritDoc
		 */
		public function BootstrapFlexMoxieStylesheetModel( $progress:IProgress )
		{
			super( $progress );
		}
		...
		public function load( $data:XMLList ):void
		{
				...
				$data.length() > 0 )
			{
				...
				for( var i : int = 0; i < xml_len; i++ )
				{
					...
					var service : IFlexMoxieStylesheetService = new FlexMoxieStylesheetService( service_progress );
